...
/**
 * Enhanced FileDownloadEvent to support the new clean architecture download progress
 * Provides detailed download information including speed and time estimates
 */
