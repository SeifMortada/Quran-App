...
import com.seifmortada.applications.quran.core.BaseFragment
...
class AzkarsFragment : BaseFragment<FragmentAzkarsBinding, Nothing>() {
    private lateinit var adapter: com.seifmortada.applications.quran.features.azkars.fragment.azkars.AzkarsAdapter
    ...
    private fun initializeAdapter() {
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            adapter =
                com.seifmortada.applications.quran.features.azkars.fragment.azkars.AzkarsAdapter()
