...
class AudioPlayerService : Service() {
    ...
    private fun createDefaultNotification(): Notification {
        return NotificationCompat.Builder(this, AUDIO_CHANNEL_ID)
            ...
            .setSmallIcon(ServiceResources.notificationIcon)
            .build()
    }
    ...
    private fun sendNotification(audio: Audio) {
        ...
        val notification = NotificationCompat.Builder(this, AUDIO_CHANNEL_ID)
            ...
            .addAction(ServiceResources.rewindIcon, "Rewind", createActionIntent(REWIND))
            .addAction(
                if (mediaPlayer.isPlaying) ServiceResources.pauseIcon else ServiceResources.playIcon,
                if (mediaPlayer.isPlaying) "Pause" else "Play",
                createActionIntent(PLAYPAUSE)
            )
            .addAction(ServiceResources.forwardIcon, "Forward", createActionIntent(FORWARD))
            .setSmallIcon(ServiceResources.notificationIcon)
            .build()
